    ...
    var body: some View {
        NavigationStack {
            VStack(spacing: 24) {
                ...
                PendingQueueChip(waiting: pendingStore.waitingCount, unrecoverable: pendingStore.unrecoverableCount, transcribing: pendingStore.transcribingCount, onTap: onOpenPendingQueue)
